...
[![License](https://img.shields.io/github/license/flyve-mdm/flyve-mdm-deeplink.svg?&label=License)](https://github.com/flyve-mdm/flyve-mdm-deeplink/blob/develop/LICENSE.md)
...
guidelines for [contributing](./CONTRIBUTING.md) and then check out one of our issues in the [Issues Dashboard](https://github.com/flyve-mdm/flyve-mdm-deeplink/issues).
